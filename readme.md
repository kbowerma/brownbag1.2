...
#### Step 3 create a node package and grab some deps

We are going to install a synthetic data generator called [fakerJS](https://github.com/marak/Faker.js/) and a date library that will help us with date time format called moment.  But first lets stub out a package.json file so we can track our dependcies, and then install faker and moment
...
#### Step 4 Draw the [rest of the owl](https://knowyourmeme.com/photos/572078-how-to-draw-an-owl)
